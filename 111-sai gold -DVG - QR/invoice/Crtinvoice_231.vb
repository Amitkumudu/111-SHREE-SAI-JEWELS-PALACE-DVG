...
Public Class Crtinvoice_231
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "invoice.Crtinvoice_231.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCrtinvoice_231
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Crtinvoice_231 = New Crtinvoice_231()
        rpt.Site = Me.Site
        Return rpt
    End Function
