...
Public Class crtinsurance_old1
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "invoice.crtinsurance_old1.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedcrtinsurance_old1
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As crtinsurance_old1 = New crtinsurance_old1()
        rpt.Site = Me.Site
        Return rpt
    End Function
