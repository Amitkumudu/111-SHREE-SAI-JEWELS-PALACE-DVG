...
Partial Public Class dsinvoice
    ...
    Partial Public Class rptheaderDataTable
        ...
        Public Overloads Function AddrptheaderRow( _
                    ...
                    ByVal irn_AckDt As String,  _
                    ByVal irn As String,  _
                    ByVal created_date As Date) As rptheaderRow
            Dim rowrptheaderRow As rptheaderRow = CType(Me.NewRow,rptheaderRow)
            Dim columnValuesArray() As Object = New Object() {id, customer, o_key, k_date, staff, r_footer, bus_hrs, com_addr, adv_detail, cash_adv, rate, name, paymode, ret_detail, adjustment, bill_recv, total, r_type, order_advance, adj_title, c_balance, k_time, note, discount, lessadvance, report_note, companyname, ordernote, taxamount, netbill, totaldiscount, advancecash, totalbill, wttowt, comp_address, QRCoder, irn_AckNo, irn_AckDt, irn, created_date}
    ...
    Partial Public Class rptsessionDataTable
        ...
        Public Overloads Function AddrptsessionRow( _
                    ...
                    ByVal mc_after_discount As Double) As rptsessionRow
            Dim rowrptsessionRow As rptsessionRow = CType(Me.NewRow,rptsessionRow)
            Dim columnValuesArray() As Object = New Object() {key, id, slno, metal, item, beedname, gross, beeds, mc, size, purity, note, ivalue, pcs, b_pcs, b_ct, b_class, rate, rtype, mcpg, customer, d_date, staff, wastage, adv_detail, image, filepath, hc, hsncode, Skin, mc_after_discount}
    ...
    Partial Public Class rptheaderRow
        ...
        Public Property comp_address() As String
            Get
                Try 
                    Return CType(Me(Me.tablerptheader.comp_addressColumn),String)
                Catch e As Global.System.InvalidCastException
                    Throw New Global.System.Data.StrongTypingException("The value for column 'comp_address' in table 'rptheader' is DBNull.", e)
                End Try
            End Get
            Set
                Me(Me.tablerptheader.comp_addressColumn) = value
            End Set
        End Property
        ...
        Public Property created_date() As Date
            Get
                Try 
                    Return CType(Me(Me.tablerptheader.created_dateColumn),Date)
                Catch e As Global.System.InvalidCastException
                    Throw New Global.System.Data.StrongTypingException("The value for column 'created_date' in table 'rptheader' is DBNull.", e)
                End Try
            End Get
            Set
                Me(Me.tablerptheader.created_dateColumn) = value
            End Set
        End Property
        ...
        Public Function Iscomp_addressNull() As Boolean
            Return Me.IsNull(Me.tablerptheader.comp_addressColumn)
        End Function
        
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")>  _
        Public Sub Setcomp_addressNull()
            Me(Me.tablerptheader.comp_addressColumn) = Global.System.Convert.DBNull
        End Sub
        ...
        Public Function Iscreated_dateNull() As Boolean
            Return Me.IsNull(Me.tablerptheader.created_dateColumn)
        End Function
        
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")>  _
        Public Sub Setcreated_dateNull()
            Me(Me.tablerptheader.created_dateColumn) = Global.System.Convert.DBNull
        End Sub
    End Class
