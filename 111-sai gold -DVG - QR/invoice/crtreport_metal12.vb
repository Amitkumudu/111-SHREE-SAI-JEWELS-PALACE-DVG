...
Public Class crtreport_metal12
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "invoice.crtreport_metal12.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedcrtreport_metal12
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As crtreport_metal12 = New crtreport_metal12()
        rpt.Site = Me.Site
        Return rpt
    End Function
