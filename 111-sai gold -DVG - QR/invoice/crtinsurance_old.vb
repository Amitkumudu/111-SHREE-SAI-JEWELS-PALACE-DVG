...
Public Class crtinsurance_old
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "invoice.crtinsurance_old.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedcrtinsurance_old
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As crtinsurance_old = New crtinsurance_old()
        rpt.Site = Me.Site
        Return rpt
    End Function
